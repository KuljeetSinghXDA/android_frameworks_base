...
public class CaffeineTile extends QSTileImpl<BooleanState> {
    ...
    private boolean setCpuInfoEnabled() {
        boolean enabled = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.OMNI_SHOW_CPU_OVERLAY, 1) != 0;
        Intent service = (new Intent())
                .setClassName("com.android.systemui",
                "com.android.systemui.CPUInfoService");
        if (!enabled) {
            Settings.System.putInt(
                mContext.getContentResolver(), Settings.System.OMNI_SHOW_CPU_OVERLAY, 1);
            mContext.startService(service);
        } else {
            Settings.System.putInt(
                mContext.getContentResolver(), Settings.System.OMNI_SHOW_CPU_OVERLAY, 0);
