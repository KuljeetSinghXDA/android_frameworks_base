...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    private class OmniSettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(
                    ...
                    false, this, UserHandle.USER_ALL);
            mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(
                    Settings.System.OMNI_SYSUI_ROUNDED_FWVALS),
                    false, this, UserHandle.USER_ALL);
            mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(
    ...
    public void updateMediaMetaData(boolean metaDataChanged, boolean allowEnterAnimation) {
        ...
        if (mediaMetadata != null && SHOW_LOCKSCREEN_MEDIA_ARTWORK && !mHideLockscreenArtwork) {
    ...
    public boolean isCurrentRoundedSameAsFw() {
        ...
        int cornerRadius = Settings.Secure.getInt(mContext.getContentResolver(),
                Settings.Secure.OMNI_SYSUI_ROUNDED_SIZE, cornerRadiusRes);
        int contentPadding = Settings.Secure.getInt(mContext.getContentResolver(),
                Settings.Secure.OMNI_SYSUI_ROUNDED_CONTENT_PADDING, contentPaddingRes);
    ...
    private void updateCorners() {
        boolean sysuiRoundedFwvals = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.OMNI_SYSUI_ROUNDED_FWVALS, 1, UserHandle.USER_CURRENT) == 1;
        if (sysuiRoundedFwvals && !isCurrentRoundedSameAsFw()) {
            ...
            if (res != null) {
                ...
                Settings.Secure.putInt(mContext.getContentResolver(),
                    Settings.Secure.OMNI_SYSUI_ROUNDED_SIZE, (int) (res.getDimension(resourceIdRadius) / density));
                int resourceIdPadding = res.getIdentifier("com.android.systemui:dimen/rounded_corner_content_padding", null, null);
                Settings.Secure.putInt(mContext.getContentResolver(),
                    Settings.Secure.OMNI_SYSUI_ROUNDED_CONTENT_PADDING, (int) (res.getDimension(resourceIdRadius) / density));
            }
        }
    }
